...
// class FormSelectPriority extends Select {
//   constructor(id, ...classArr) {
//     super(id, ...classArr);
//   }
//
//   render() {
//     const highPriority = new Option('Высокая', 'highPriority', "", '', '');
//     const middlePriority = new Option('Обычная', 'middlePriority', "", '', '');
...
//
//
// let formPriorityWrapper = document.createElement('div');
// formPriorityWrapper.id = 'form-priority-container';
//
//
// const formVisitPriority = new Select('form-visit-priority', 'select');
// const formPriorityContainer = document.getElementById('form-priority-container');
// formVisitPriority.render(formPriorityContainer);
//
// const formSelectPriority = new FormSelectPriority();
// formSelectPriority.render();
